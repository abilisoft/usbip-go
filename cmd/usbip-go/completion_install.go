...
// default in the same share tree. The basename matches the binary
// name so shell completion drivers (bash-completion, zsh's compdef)
// look it up under the command operators actually type.
