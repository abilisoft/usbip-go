...
- **WHEN** `usbip-go attach HOST BUSID` hands a connection to the kernel and exits
- **AND** a later independent `usbip-go detach N` process targets its acknowledged PortID
