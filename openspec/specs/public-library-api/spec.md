...
The public API SHALL expose `BackoffStrategy`, `FixedBackoff`, and `ExponentialBackoff` for reconnect timing.

#### Scenario: Exponential backoff is constructed
- **WHEN** `NewExponentialBackoff` receives invalid Min, Max, or Jitter values
