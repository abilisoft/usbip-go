...
- [ ] 4.3 Run the repository Go/CI/release-snapshot gates and fresh mutation testing without weakening resource limits
- [ ] 4.4 Create and verify a signed Conventional Commit with no attribution trailers, publish through a pull request, and confirm all required checks
