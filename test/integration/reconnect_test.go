...
//  5. The watcher observes PortDetached via uevent (importer-lifecycle OpenSpec item 1)
//     OR ListPorts poll (importer-lifecycle OpenSpec item 2), invokes Importer.Attach
